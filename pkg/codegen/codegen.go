...
import (
	...
	"github.com/marvell/oapi-codegen/pkg/codegen/templates"
)
...
var (
	allGoImports = goImports{
		...
		{lookFor: "openapi_types\\.", alias: "openapi_types", packageName: "github.com/marvell/oapi-codegen/pkg/types"},
		{lookFor: "path\\.", packageName: "path"},
		{lookFor: "runtime\\.", packageName: "github.com/marvell/oapi-codegen/pkg/runtime"},
